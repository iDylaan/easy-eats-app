        ...
        <div class="card">
            <form novalidate>
                ...
                <div :class="emailClasses">
                    ...
                    <input v-model="email" @input="validarEmail" autocomplete="off" id="email" placeholder="Correo" class="input-field" name="email"
                        type="email" />
                </div>
                <div :class="passwordClasses">
                    ...
                    <input v-model="password" @input="validarPassword" autocomplete="off" id="password" placeholder="Contraseña" class="input-field" name="password"
                        type="password" />
                </div>
                <button @click.prevent="submitForm" @click="login" :disabled="!formValid" class="btn" type="submit">Iniciar Sesión</button>
