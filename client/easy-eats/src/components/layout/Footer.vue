    ...
    <footer>
        ...
        <div class="container__footer">
            <div class="box__footer">
                ...
                <div class="terms">
                    <p>En nuestro sitio web, respetamos su privacidad y nos comprometemos a proteger sus datos personales.
                    </p>
                </div>
            </div>
            <div class="box__footer">
        ...
        <div class="box__copyright">
            ...
            <p>Desarrollado en la <b>Universidad Tecnológica De Nezahualcóyotl</b></p>
        </div>
    </footer>
</template>
